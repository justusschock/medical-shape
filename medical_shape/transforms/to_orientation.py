...
class ToOrientation(TransformShapeValidationMixin):
    def __init__(self, axcode: Optional[Sequence[str]] = None, affine: Optional[np.ndarray] = None, shape_trafo_image_size: Optional[Sequence[int]] = None, shape_trafo_image_key: Optional[str] = None, **kwargs):
